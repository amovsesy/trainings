...
bool CPlayer::SetCameraMode( ULONG Mode )
{
    ...
    switch ( Mode )
    {
        ...
        case CCamera::MODE_THIRDPERSON_SC:
    ...
    if ( m_CameraMode == CCamera::MODE_SPACECRAFT || m_CameraMode == CCamera::MODE_THIRDPERSON_SC )
    {
    ...
    else if ( m_pCamera && Mode == CCamera::MODE_SPACECRAFT || Mode == CCamera::MODE_THIRDPERSON_SC )
    {
...
void CPlayer::Rotate( float x, float y, float z )
{
    ...
    else if ( m_CameraMode == CCamera::MODE_SPACECRAFT || m_CameraMode == CCamera::MODE_THIRDPERSON_SC )
    {
        // Allow camera to rotate prior to updating our axis
        m_pCamera->Rotate( x, y, z );
...
void CPlayer::Render( LPDIRECT3DDEVICE9 pDevice )
{
    ...
    if ( m_pCamera )
    {
        if ( m_CameraMode == CCamera::MODE_THIRDPERSON || m_CameraMode == CCamera::MODE_THIRDPERSON_SC ) pObject = m_p3rdPersonObject;
