...
////////////////////////////////////////////////////////////////////////
// (this is just one of many, many possible solutions to this problem)
////////////////////////////////////////////////////////////////////////

bool PointInRect(Rectangle rect, Point point)
{
	// test if point is in horizontal limits -- if not, return false
	if (( point.x < rect.left) || ( point.x > rect.right ))
		return false;

	// test if point is in vertical limits -- if not return false
	if (( point.y < rect.top ) || ( point.y > rect.bottom ))
		return false;

	// the point isn't outside, so it _must_ be inside
	return true;
}
