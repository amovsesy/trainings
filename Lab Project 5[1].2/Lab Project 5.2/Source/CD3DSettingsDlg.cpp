...
//-----------------------------------------------------------------------------
// Name : CD3DSettingsDlg () (Constructor)
...
//-----------------------------------------------------------------------------
// Name : ~CD3DSettingsDlg () (Destructor)
...
//-----------------------------------------------------------------------------
BOOL CALLBACK CD3DSettingsDlg::StaticDlgProc( HWND hWnd, UINT Message, WPARAM wParam, LPARAM lParam)
{
...
void CD3DSettingsDlg::DeviceChanged(  )
{
    ...
    {
        CD3DEnumDeviceOptions * pDeviceOptions = (CD3DEnumDeviceOptions*)pDevice->Options[ i ];
